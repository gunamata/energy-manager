...
export class Config {
  ...
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'energymanager';
  ...
  'jhipster.mail.from' = 'energymanager@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'energymanager API';
  'jhipster.swagger.description' = 'energymanager API documentation';
  ...
  'eureka.instance.appname' = 'energymanager';
  'eureka.instance.instanceId' = 'energymanager:${random.value}';
  ...
  'cloud.config.name' = 'energymanager';
